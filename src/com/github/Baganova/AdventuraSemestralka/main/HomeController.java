package com.github.Baganova.AdventuraSemestralka.main;

import com.github.Baganova.AdventuraSemestralka.logika.Hra;
import java.util.Observable;
import java.util.Observer;

import com.github.Baganova.AdventuraSemestralka.logika.IHra;
import com.github.Baganova.AdventuraSemestralka.logika.Prostor;
import com.github.Baganova.AdventuraSemestralka.logika.Vec;
import java.net.URL;
...
public class HomeController extends GridPane implements Observer, Initializable {
	...
	@Override
         ...
         @FXML public void Napoveda() 
        {
            ...
            webView.getEngine().load(com.github.Baganova.AdventuraSemestralka.main.GuiAdventura.class.getResource("/zdroje/napoveda.html").toExternalForm());
	...
	public void update(Observable arg0, Object arg1) 
		...
		String sVychody = hra.getHerniPlan().getAktualniProstor().seznamVychodu();
                ...
                for (String x : sBatoh.keySet()) 
                {
                    ...
                    ImageView obrazek = new ImageView(new Image(com.github.Baganova.AdventuraSemestralka.main.GuiAdventura.class.getResourceAsStream("/zdroje/"+pomocna.getObrazek()), 100, 100, false, false));
